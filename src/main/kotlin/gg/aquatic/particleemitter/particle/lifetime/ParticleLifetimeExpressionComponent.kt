...
class ParticleLifetimeExpressionComponent(private val lifetimeExpression: CompiledScript?, private val maxLife: Int?, private val myParticleData: ParticleData, private val myEmitterData: EmitterData) :
    gg.aquatic.particleemitter.particle.lifetime.ParticleLifetimeComponent {
    companion object : ComponentParser<gg.aquatic.particleemitter.particle.lifetime.ParticleLifetimeComponent> {
        init {
            ParticleJsonParser.particleLifetimeComponentParsers += "particle_lifetime_expression" to this
        }

        override fun parse(jsonElement: JsonElement): gg.aquatic.particleemitter.particle.lifetime.ParticleLifetimeExpressionComponent {
            ...
            return gg.aquatic.particleemitter.particle.lifetime.ParticleLifetimeExpressionComponent(
